<?php
	...
	class Medico extends CI_Controller {
		...
		function index(){
			...
			$recibodatos['cn']=$this->medico_model->consultar_perfil($this->session->userdata('s_id'));
			$this->load->view('plantilla/header');
			$this->load->view('plantilla/menu_m');
			$this->load->view('perfil/vmedico',$recibodatos);
		...
		function actualizar(){
			...
			// $datos['img_medico']=$this->input->post('ftanterior');
			...
			$rs=$this->medico_model->actualizar_perfil($datos);
			echo $rs;
		}
		function calcular(){
			$dato=$this->input->post('lafecha');
			$rs=$this->medico_model->calcular_edad($dato);
			echo $rs;			
		}
