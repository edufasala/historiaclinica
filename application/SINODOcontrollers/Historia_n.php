<?php
	...
	class Historia_n extends CI_Controller{
		...
		function index(){
			...
			$this->load->view('hclinica_n/vreghistoria');
		...
		function registrar_pad(){
			...
			$rs=$this->historia_n_model->registrar_historiapad($datos);
			echo $rs;
		}
		function actualizar_pad(){
			...
			$rs=$this->historia_n_model->actualizar_historiapad($datos);
			echo $rs;
		}
		...
		function registrar_valoracion(){
			...
			$rs=$this->historia_n_model->registrar_historiavarloracion($datos);
			echo $rs;
		}
		function actualizar_valoracion(){
			...
			$rs=$this->historia_n_model->actualizar_historiavarloracion($datos);
			echo $rs;
		}
		function registrar_norton(){
			...
			$rs=$this->historia_n_model->registrar_historianorton($datos);
			echo $rs;
		}
		function actualizar_norton(){
			...
			$rs=$this->historia_n_model->actualizar_historianorton($datos);
			echo $rs;
		}
		function registrar_braden(){
			...
			$rs=$this->historia_n_model->registrar_historiabraden($datos);
			echo $rs;
		}
		function actualizar_braden(){
			...
			$rs=$this->historia_n_model->actualizar_historiabraden($datos);
			echo $rs;
		}
		function mostrar_paciente(){
			$nom=$this->input->post('nomb');
			
			$datos=$this->historia_n_model->buscar_paciente_nombres($nom);
