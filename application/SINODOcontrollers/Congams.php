<?php
	...
	class Congams extends CI_Controller {
		...
		function buscar_nombres(){
			...
			$datos=$this->gams_model->consultar_cita_nombres($busqueda);
			echo json_encode($datos);
		}
		function mostrar(){
			// $busqueda=$this->input->post('buscar');
			
			$datos=$this->gams_model->consultar_cita_todas();
			echo json_encode($datos);
		}
		function obtener_server_gams(){
			...
			$losdatos=$this->gams_model->consultar_separados_gams($start,$length,$search,$orden_dir,$orden_columna);
			// var_dump($losdatos);
			...
			foreach ($datos->result_array() as $row) {
				...
				$array['gams_tipo_edad']=$row['gams_tipo_edad'];
				$array['gams_tipo_analisis']=$row['gams_tipo_analisis'];
				$array['gams_f_gams']=$row['gams_f_gams'];
				$array['gams_h_gams']=$row['gams_h_gams'];
				$array['gams_nota']=$row['gams_nota'];
				$array['gams_f_reg']=$row['gams_f_reg'];
				$array['gams_h_reg']=$row['gams_h_reg'];
				$array['inclusion_pad_paciente']=$row['inclusion_pad_paciente'];
				$array['id_gams']=$row['id_gams'];
				// $array['']=$row[''];
				// $array['']=$row[''];
				$resultado[]=$array;
			}
		...
		function mostrar_gams(){
			$busqueda=$this->input->post('id');
			$datos=$this->gams_model->consultar_gams($busqueda);
			echo json_encode($datos);
		}
	}
?>