<?php
	...
	class Historia_enfermera_n extends CI_Controller{
		...
		function index(){
            ...
            else if($cargo=="2")
            {
				...
				$this->load->view('hclinica_enfermera_n/vreghistoria_enfermera');
		...
		function registrar_pad_enf(){
			...
			$rs=$this->historia_enfermera_n_model->registrar_historiapad_enf($datos);
			echo $rs;
		}
		function actualizar_pad_enf(){
			...
			$rs=$this->historia_enfermera_n_model->actualizar_historiapad_enf($datos);
			echo $rs;
		}
		function registrar_socio_enf(){
			...
			$rs=$this->historia_enfermera_n_model->registrar_historiasocio_enf($datos);
			echo $rs;
		}
		function actualizar_socio_enf(){
			...
			$rs=$this->historia_enfermera_n_model->actualizar_historiasocio_enf($datos);
			echo $rs;
		}
		function registrar_escala_enf(){
			...
			$rs=$this->historia_enfermera_n_model->registrar_historiaescala_enf($datos);
			echo $rs;
		}
		function actualizar_escala_enf(){
			...
			$rs=$this->historia_enfermera_n_model->actualizar_historiaescala_enf($datos);
			echo $rs;
		}
		function registrar_intervencion_enf(){
			...
			$rs=$this->historia_enfermera_n_model->registrar_historiintervencion_enf($datos);
			echo $rs;
		}
		function actualizar_intervencion_enf(){
			...
			$rs=$this->historia_enfermera_n_model->actualizar_historiintervencion_enf($datos);
			echo $rs;
		}
		...
		function mostrar_paciente(){
			...
			$datos=$this->historia_enfermera_n_model->buscar_paciente_nombres($nom);
		...
		function editar_motivo(){
			...
			$rs=$this->historia_enfermera_n_model->cambios_motivo($datos);
			echo $rs;
		}
	}
?>