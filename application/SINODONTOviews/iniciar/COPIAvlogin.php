...
<html lang="es">
	...
	<div class="login-box" style="background:url('<?php echo base_url();?>/assets/img/consultorio3.jpg')"><!-- style="background-image:url('img/piel.jpg'); width: 100%; height: ;" --> 
	    ...
	    <div class="card-body login-card-body ">
	      ...
	      <form id="rdem" onsubmit="return validar();" method="post">
	        ...
	        <div class="col-md-12 text-center">
				<div class="g-recaptcha" data-sitekey="6Ld3qPAUAAAAABapTBeYVRYHa6_Vfc2iO-_Bp0UC"></div>
			</div>
			</div>
