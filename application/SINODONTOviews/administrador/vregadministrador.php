        ...
        <form id="rdem" action="#" method="post" enctype="multipart/form-data">
              <div class="form-row p-2">
                ...
                <div class="form-group col-sm-2">
                  <button type="button" id="btngdadmin" class="btn btn-azul" data-dismiss="modal" data-toggle="modal" data-target="#confirmar" >REGISTRAR</button>
                </div>
            ...
            <div class="modal" id="confirmar" tabindex="-1" role="dialog">
              <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                  <h5 class="text">Estas Seguro de Registrar Esta Administrador</h5>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick="inadministrador();"> Si </button>
