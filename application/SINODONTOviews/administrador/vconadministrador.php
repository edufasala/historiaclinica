    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Consultar Admnistrador</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admnistrador</a></li>
              <li class="breadcrumb-item active">Consultar Admnistrador</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- <div class="card"> -->
        <div class="col-12" >
            <div class="card" >
              <div class="card-header">
                <h3 class="card-title">Listado de Admnistradores</h3>
            ...
            <form id="inftr" method="post" enctype="multipart/form-data">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Detalles del Administrador</h4>
                  ...
                  <div class="container">
                    ...
                    <div class="row">
                      <div class="form-group col-md-5">
                        ...
                        <input size="" type="date" class="form-control" id="fnaci" name="fnaci" onchange="calcularedad3()" required/>
                      </div>
                      <div class="form-group col-md-5">
                ...
                <div class="modal-footer">
                  <button type="button" id="btnactadmin" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#confirme">ACTUALIZAR</button>
        ...
        <div class="modal" id="confirme" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-body">
                <h5 class="text">Estas Seguro de Actualizar Este Administrador</h5>
                  <p></p>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-danger" onclick="actadministrador();"> Si </button>
    ...
    <script type="text/javascript">
          ...
          window.onload = function() {
             document.title="Cons. Administradores | H. Clinica";
            ...
            $('#resultado').DataTable( {
                ...
                dom: 'Bfrtlip',
                'ajax':{
                  "url":baseurl+"conadministrador/obtener_server_administrador",
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
                ...
                'columns':[
                  ...
                  {"orderable":true,
                    render:function(data,type,row){
                      return '<a href="#" class="btn btn-azul"  data-toggle="modal" data-target="#mdetalles" onclick="datosadministrador(\''+row.id_registro_usuario+'\',\''+row.registro_nombres+'\',\''+row.registro_apellidos+'\',\''+row.registro_f_nacimiento+'\',\''+row.registro_edad+'\',\''+row.registro_celular+'\',\''+row.registro_sexo+'\',\''+row.registro_img+'\',\''+row.registro_tipo+'\',\''+row.registro_estado+'\')"><img src="'+baseurl+'assets/img/iconos/ver.png" class="img-fluid" width="25" height="25"/></a>';
                    }
                  }
                ],
                  // "order": [[ 3, "desc" ]],
