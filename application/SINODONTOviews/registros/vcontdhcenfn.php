        ...
        <div class="col-12" >
            <div class="card" >
              <div class="card-header">
                <h3 class="card-title">Listado de Historias Clinicas de Enfermera</h3>

                <div class="card-tools">
                  <div class="input-group input-group-md" style="width: 250px;">
                    <select class="form-control" id="selimprimir" name="selimprimir" onchange="buscarhistoria()">
                      <option value="general">General</option>
                      <option value="pad">Historia de Enfermera</option>
            ...
            $.extend( true, $.fn.dataTable.defaults, {
             ...
             $('#resultado').DataTable( {
                ...
                'responsive':true,
                 dom: 'Bfrtlip',  
                'ajax':{
                  "url":baseurl+"registro/obtener_server_hc_enf_general_n",
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
              ...
              $("#resultado").dataTable().fnDestroy();
                $('#resultado').DataTable( {
                  ...
                  'responsive':true,
                   dom: 'Bfrtlip',  
                  'ajax':{
                    "url":baseurl+"registro/obtener_server_hc_enf_"+sel+"_n",
                    "type":"POST"
                    // dataSrc:''
                  },
                  'buttons': [
