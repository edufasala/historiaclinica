                                                    ...
                                                    <div class="form-group col-md-12">
                                                      ...
                                                      <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                          ...
                                                          <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="d4movilidad" id="csed4movilidad2" onclick=""  value="hemiparesia">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <div class="row">
                                                  <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-check">
                                                      <input class="form-check-input" type="checkbox" id="cselist18" name="cselist18" onclick="" value="Motilidad intestina">
