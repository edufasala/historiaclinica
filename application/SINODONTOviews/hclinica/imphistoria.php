<?php
	...
	foreach ($cn['hc'] as $fila)
	{
		...
		$obldig=strtoupper($fila->diagnosticos);
	...
	$pdf->Cell(180,5, 'Dr. '.$obmedico,0,1,'C');
	...
	$pdf->Ln(1);
	$pdf->SetFont('Arial','',11);
	$pdf->Cell(70,0,utf8_decode('Codigo:').$obid.utf8_decode('  Historia Clinica N°:').$obnrohc,0,0,1);
	$pdf->Cell(80);
	...
	#$pdf->SetAuthor('HISsadasd asda', true);
	$pdf->Output();
?>