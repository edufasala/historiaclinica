            ...
            <form id="inf" method="post" onsubmit="return actualizarcita();">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" >Detalles de la Evoluicon Enf</h4>
    ...
    <script type="text/javascript">
          ...
          document.title="Cons. Evoluciones Enf | H. Clinica";
          window.onload = function() {
            ...
            $('#resultado').DataTable( {
                ...
                dom: 'Bfrtlip',
                'ajax':{
                  "url":baseurl+"convisita/obtener_server_visitas",
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
                ...
                'columns':[
                  ...
                  {"orderable":true,
                    render:function(data,type,row){
                        return '<a href="#" class="btn btn-azul"  data-toggle="modal" data-target="#mdetalles" onclick="datosvisita(\''+row.id_visita+'\',\''+row.pnombre_paciente+'\',\''+row.papellido_paciente+'\',\''+row.inclusion_pad_paciente+'\',\''+row.visita_f_visita+'\',\''+row.visita_h_visita+'\',\''+row.visita_control_liquidos+'\',\''+row.visita_fc+'\',\''+row.visita_fr+'\',\''+row.visita_t+'\',\''+row.visita_ta+'\',\''+row.visita_saturacion+'\',\''+row.visita_glucometria+'\')"><img src="'+baseurl+'assets/img/iconos/ver.png" class="img-fluid" width="25" height="25"/></a><a  href="'+baseurl+'imprimir/generar_visita/'+row.id_visita+'/'+row.doc_paciente+'/EV" class="btn btn-rosado" title="Imprimir" onclick="" target="_blank"><img src="'+baseurl+'assets/img/iconos/oj.png" class="img-fluid" width="25" height="25"/></a>';
                    }
                  }
                ],
                  // "order": [[ 3, "desc" ]],
