        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Consultar Notas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="modal-body">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <label class="col-form-label">Fecha de la Nota</label>
                        <input size="16" type="date" class="form-control" id="mff" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <label>Hora de la Nota</label>
    ...
    <script type="text/javascript">
          ...
          document.title="Cons. Notas | H. Clinica";
          window.onload = function() {
            ...
            $('#resultado').DataTable( {
                ...
                dom: 'Bfrtlip',
                'ajax':{
                  "url":baseurl+"connota/obtener_server_notas",
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
                ...
                'columns':[
                  ...
                  {"orderable":true,
                    render:function(data,type,row){
                        return '<a href="#" class="btn btn-azul"  data-toggle="modal" data-target="#mdetalles" onclick="datosnota(\''+row.id_nota+'\',\''+row.pnombre_paciente+'\',\''+row.papellido_paciente+'\',\''+row.inclusion_pad_paciente+'\')"><img src="'+baseurl+'assets/img/iconos/ver.png" class="img-fluid" width="25" height="25"/></a><a  href="'+baseurl+'imprimir/generar_nota/'+row.id_nota+'/'+row.doc_paciente+'/NT" class="btn btn-rosado" title="Imprimir" onclick="" target="_blank"><img src="'+baseurl+'assets/img/iconos/oj.png" class="img-fluid" width="25" height="25"/></a>';
                    }
                  }
                ],
                  // "order": [[ 3, "desc" ]],
