<?php
	...
	class Historia_enfermera_n_model extends CI_Model
	{
		...
		function buscar_registros_paciente_escalas_enf($doc){
			...
			$consulta7="SELECT enf_valoracion_situacion_total FROM hc_enf_valoracion WHERE enf_valoracion_doc='".$doc."' and enf_valoracion_f_reg='".$getfecha."' ";// hc_enf_valoracion_cod>'1'
			...
			$consulta8="SELECT enf_valoracion_aydtotal FROM hc_enf_valoracion WHERE enf_valoracion_doc='".$doc."' and enf_valoracion_f_reg='".$getfecha."' ";
			...
			$consulta9="SELECT enf_escala_total FROM hc_enf_escala WHERE enf_escala_doc='".$doc."' and enf_escala_f_reg='".$getfecha."' ";
		...
		function registrar_historiapad_enf($datos){
			...
			if($result>=1)
			{
				$existe2="SELECT COUNT(*) hc_enf_pad FROM hc_enf_pad WHERE enf_pad_doc='".$datos['enf_pad_doc']."' and enf_pad_f_reg='".$datos['enf_pad_f_reg']."' and hc_enf_pad_cod>'1' ";
				$resultado2=$this->db->query($existe2);
				$resultado2=$resultado2->row();
				$result2=$resultado2->hc_enf_pad;
				if($result2>0)
				{
					return 0;
				}
		...
		function registrar_historiasocio_enf($datos){
			...
			$getfecha=date("Y-m-d");
			$gethora=date("h:i:s");
			$pvalidar="SELECT enf_pad_f_reg FROM hc_enf_pad WHERE enf_pad_doc='".$datos['enf_valoracion_doc']."' and hc_enf_pad_cod>'1' and enf_pad_f_reg='".$getfecha."' ";
			$pvalidar=$this->db->query($pvalidar);
			$pvalidar=$pvalidar->row();
			if($pvalidar)
			{
				$pvalidar=$pvalidar->enf_pad_f_reg;
				if($pvalidar==$datos['enf_valoracion_f_reg'])
				{
					$existe="SELECT COUNT(*) hc_enf_valoracion FROM hc_enf_valoracion WHERE enf_valoracion_doc='".$datos['enf_valoracion_doc']."' and enf_valoracion_f_reg='".$datos['enf_valoracion_f_reg']."' ";
					$resultado=$this->db->query($existe);
					$resultado=$resultado->row();
					$result=$resultado->hc_enf_valoracion;
					// if($resultado->num_rows()==1)
					// {
					// 	$resultado=$resultado->row();
					// 	$result=$resultado->enf_valoracion_doc;
					// }
					// else
					// {
					// 	$result="";
					...
					else
					{
						...
						$seguir="SELECT COUNT(*) hc_enf_valoracion_cod FROM hc_enf_valoracion WHERE enf_valoracion_doc='".$datos['enf_valoracion_doc']."' ";
						$seguir=$this->db->query($seguir);
						$seguir=$seguir->row();
						$seguir=$seguir->hc_enf_valoracion_cod;
						if($seguir==0)
						{
							$suma2=1;
						}
		...
		function registrar_historiaescala_enf($datos){
			...
			$now = time();
			$getfecha=date("Y-m-d");
			$pvalidar="SELECT enf_pad_f_reg FROM hc_enf_pad WHERE enf_pad_doc='".$datos['enf_escala_doc']."' and hc_enf_pad_cod>'1' and enf_pad_f_reg='".$getfecha."' ";
			$pvalidar=$this->db->query($pvalidar);
			$pvalidar=$pvalidar->row();
			if($pvalidar)
			{
				$pvalidar=$pvalidar->enf_pad_f_reg;
				if($pvalidar==$datos['enf_escala_f_reg'])
				{
					$existe="SELECT COUNT(*) hc_enf_escala FROM hc_enf_escala WHERE enf_escala_doc='".$datos['enf_escala_doc']."' and enf_escala_f_reg='".$datos['enf_escala_f_reg']."' ";
					$resultado=$this->db->query($existe);
					$resultado=$resultado->row();
					$result=$resultado->hc_enf_escala;
					// if($resultado->num_rows()==1)
					// {
					// 	$resultado=$resultado->row();
					// 	$result=$resultado->enf_escala_doc;
					// }
					// else
					// {
					// 	$result="";
					...
					else
					{
						...
						$seguir="SELECT COUNT(*) hc_enf_escala_cod FROM hc_enf_escala WHERE enf_escala_doc='".$datos['enf_escala_doc']."' ";
						$seguir=$this->db->query($seguir);
						$seguir=$seguir->row();
						$seguir=$seguir->hc_enf_escala_cod;
						if($seguir==0)
						{
							$suma2=1;
						}
		...
		function registrar_historiintervencion_enf($datos){
			...
			$now = time();
			$getfecha=date("Y-m-d");
			$pvalidar="SELECT enf_pad_f_reg FROM hc_enf_pad WHERE enf_pad_doc='".$datos['enf_intervencion_doc']."' and hc_enf_pad_cod>'1' and enf_pad_f_reg='".$getfecha."' ";
			$pvalidar=$this->db->query($pvalidar);
			$pvalidar=$pvalidar->row();
			if($pvalidar)
			{
				...
				{
					$existe="SELECT COUNT(*) enf_intervencion_doc FROM hc_enf_intervencion WHERE enf_intervencion_doc='".$datos['enf_intervencion_doc']."' and enf_intervencion_f_reg='".$datos['enf_intervencion_f_reg']."' ";
					$resultado=$this->db->query($existe);
					$resultado=$resultado->row();
					...
					else
					{
						...
						$seguir="SELECT COUNT(*) hc_enf_intervencion_cod FROM hc_enf_intervencion WHERE enf_intervencion_doc='".$datos['enf_intervencion_doc']."' ";
						$seguir=$this->db->query($seguir);
						$seguir=$seguir->row();
						$seguir=$seguir->hc_enf_intervencion_cod;
						if($seguir==0)
						{
							$suma2=1;
						}
		...
		function consultar_historia_pad_enf($id){
			$this->db->where("enf_pad_doc",$id);
			$consulta=$this->db->get("hc_enf_pad");
			return $consulta->result();
		...
		function consultar_historia_valoracion_enf($id){
			$this->db->where("enf_valoracion_doc",$id);
		...
		function consultar_historia_escala_enf($id){
			$this->db->where("enf_escala_doc",$id);
		...
		function consultar_historia_intervencion_enf($id){
			$this->db->where("enf_intervencion_doc",$id);
