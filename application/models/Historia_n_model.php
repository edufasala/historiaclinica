<?php
	...
	class Historia_n_model extends CI_Model
	{
		...
		function consultar_historia_pad($id){
			$this->db->where("pad_documento",$id);
		...
		function consultar_historia_valoracion($id){
			$this->db->where("valoracion_doc",$id);
		...
		function consultar_historia_norton($id){
			$this->db->where("norton_doc",$id);
		...
		function consultar_historia_braden($id){
			$this->db->where("braden_doc",$id);
