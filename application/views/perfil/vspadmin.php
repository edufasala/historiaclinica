<section class="content-header">
    ...
    <div class="card">
      <?php
        ...
        {
          $axsex="m";
        }//actualizar los perfiles y luego lo demas que falta
      ?>
      <form id="actpf" action="#" method="post" enctype="multipart/form-data">
              <div class="form-row p-2">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input size="16" type="date" class="form-control" id="fnaci" name="fnaci" value="<?php echo $cn[0]->registro_f_nacimiento?>" onchange="calcularedad9()" required>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="" id="elnreg" name="elnreg" value="<?php echo $cn[0]->registro_n_medico?>" title="Solo Numeros min:2 max:20" pattern="[0-9]{20}" maxlength="20" required/>
                  </div>                  
                </div>
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="" id="elndoc" name="elndoc" value="<?php echo $cn[0]->registro_doc?>" title="Solo Numeros min:5 max:10" pattern="[0-9]{10}" maxlength="10" required/>
                  </div>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="" id="laespec" name="laespec" value="<?php echo $cn[0]->registro_especialidad?>" minlength="2" maxlength="35" pattern="\S[A-Za-z ]{2,35}" required/>
                  </div>                                             
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-sm-2">
                  <button type="button" id="btnperfilsp" class="btn btn-azul" data-dismiss="modal" data-toggle="modal" data-target="#confirmar">ACTUALIZAR</button>
                </div>
              ...
              <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick="actperfilsuper();"> Si </button>
