      ...
      <form id="actpf" action="#" method="post" enctype="multipart/form-data">
              <div class="form-row p-2">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input size="16" type="date" class="form-control" id="fnaci" name="fnaci" value="<?php echo $cn[0]->registro_f_nacimiento?>" onchange="calcularedad7()" required>
                ...
                <div class="form-group col-sm-2">
                  <button type="button" id="btnperfilm" class="btn btn-azul" data-dismiss="modal" data-toggle="modal" data-target="#confirmar" >ACTUALIZAR</button>
                </div>
              ...
              <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick="actperfilm();"> Si </button>
