            ...
            <form id="inf" method="post">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" id="btnactpaciente" class="btn btn-azul" data-dismiss="modal" data-toggle="modal" data-target="#confirme2">ACTUALIZAR</button>
        ...
        <div class="modal" id="confirme2" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
              ...
              <div class="modal-body">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-danger" onclick="actpc2();"> Si </button>
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                </div>
              </div>
            </div>
        </div>
        <div class="modal" id="confirme3" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title"><strong>Nombre de la entidad</strong></h5>
              ...
              <div class="modal-body">
                <h5 class="text">Subir archivo del paciente</h5>
                  <p></p>
                  <img id="imgarcpc" name="imgarcpc" width="240px" height="120px" class="img-fluid rounded">
                  <form id="rgarcpc" method="post" enctype="multipart/form-data">
                    
                  <input type="file" id="foto" name="foto" class="form-control-file" accept="image/*" required/>
                  <input type="text" id="unosid" name="unosid" class="form-control" style="display:none" />
                  </form>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-danger" onclick="actperfilmpcarc();">Guardar</button>
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                </div>
              </div>
            </div>
    ...
    <script type="text/javascript">
          ...
          document.title="Cons. Pacientes | H. Clinica";
          window.onload = function() {
            ...
            $.extend( true, $.fn.dataTable.defaults, {
                "language": {
                    ...
                    "search": "Buscar:",
                    "searchPlaceholder": "Documento, Nombres",
            ...
            $('#resultado').DataTable( {
                ...
                dom: 'Bfrtlip', 
                'ajax':{
                  "url":baseurl+"conpaciente/obtener_server_pacientes",
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
