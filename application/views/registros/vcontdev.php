<section class="content-header">
        ...
        <div class="col-12" >
            <div class="card" >
              <div class="card-header">
                <h3 class="card-title">Listado de Evolucion Medica</h3>
                      ...
                      <div class="accordion form-group col-md-12" id="accordion">
                        ...
                        <div class="card">
                          <div class="card-header" id="headi4">
                            <button class="btn btn-dark" type="button" data-toggle="collapse" data-target="#collapse4"
                                ...
                                <div class="form-group col-md-12" id="">
                                  <div class="row">
                                    <div class="form-group col-md-12">
                                      ...
                                      <textarea class="form-control" id="losdg2" name="losdg2" onkeypress="return cmTexto(event);" required></textarea>
                                    </div>
                                  </div>
                                  <div class="row" id="escreado">
    ...
    <script type="text/javascript">
          ...
          document.title="Cons. Evolucion | H. Clinica";
          window.onload = function() {
            ...
            $('#resultado').DataTable( {
                ...
                dom: 'Bfrtlip', 
                'ajax':{
                  "url":baseurl+"registro/obtener_server_ev",
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
