    ...
    <script type="text/javascript">
          ...
          window.onload = function() {
            ...
            $('#resultado').DataTable( {
                ...
                dom: 'Bfrtlip',
                'ajax':{
                  "url":baseurl+"conagenda/obtener_server_agenda",
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
                ...
                'columns':[
                  ...
                  {"orderable":true,
                    render:function(data,type,row){
                      return '<a href="#" class="btn btn-azul"  data-toggle="modal" data-target="#mdetalles" onclick="datoscita(\''+row.agendaid+'\',\''+row.pnombre_paciente+'\',\''+row.snombre_paciente+'\',\''+row.papellido_paciente+'\',\''+row.sapellido_paciente+'\',\''+row.agenda_tipo_cita+'\',\''+row.agenda_f_cita+'\',\''+row.agenda_h_cita+'\',\''+row.agenda_celular+'\',\''+row.agenda_nota_cita+'\',\''+row.agenda_estado_cita+'\',\''+row.registro_nombres+'\',\''+row.registro_apellidos+'\')"><img src="'+baseurl+'assets/img/iconos/ver.png" class="img-fluid" width="25" height="25"/></a>';
                    }
                  }
                ],
                  // "order": [[ 3, "desc" ]],
            ...
            $('#fchct').on('change',function(){
              var sel=$('#fchct').val();
               $('#resultado').dataTable().fnDestroy();
                ...
                dom: 'Bfrtlip',
                'ajax':{
                  "url":baseurl+"conagenda/obtener_server_agenda2/"+sel,
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
