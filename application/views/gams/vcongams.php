    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Consultar Gams</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Gams</a></li>
              <li class="breadcrumb-item active">Consultar Gams</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12" >
            <div class="card" >
              <div class="card-header">
                <h3 class="card-title">Listado de Gams</h3>
            ...
            <form id="inf" method="post" onsubmit="return actualizarcita();">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" >Detalles del Gams</h4>
                ...
                <div class="modal-body">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <label class="col-form-label">Fecha del Gams</label>
                        <input size="16" type="date" class="form-control" id="mff" required>
                      </div>
                      <div class="col-md-5">
                        <label>Hora del Gams</label>
    ...
    <script type="text/javascript">
          ...
          document.title="Cons. Gams | H. Clinica";
          window.onload = function() {
            ...
            $('#resultado').DataTable( {
                ...
                dom: 'Bfrtlip',
                'ajax':{
                  "url":baseurl+"congams/obtener_server_gams",
                  "type":"POST"
                  // dataSrc:''
                },
                'buttons': [
                ...
                'columns':[
                  ...
                  {data: 'gams_tipo_analisis'},
                  {data: 'gams_f_gams'},
                  // {data: 'Opciones'},
                  {"orderable":true,
                    render:function(data,type,row){
                        return '<a href="#" class="btn btn-azul"  data-toggle="modal" data-target="#mdetalles" onclick="datosgams(\''+row.id_gams+'\',\''+row.pnombre_paciente+'\',\''+row.papellido_paciente+'\',\''+row.inclusion_pad_paciente+'\',\''+row.gams_f_gams+'\',\''+row.gams_h_gams+'\',\''+row.gams_tipo_edad+'\',\''+row.gams_tipo_analisis+'\')"><img src="'+baseurl+'assets/img/iconos/ver.png" class="img-fluid" width="25" height="25"/></a>';
                    }
                  }
                ],
                  // "order": [[ 3, "desc" ]],
