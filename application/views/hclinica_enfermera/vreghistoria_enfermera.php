                                          ...
                                          <div class="card-body">
                                            <div class="row">
                                              ...
                                              <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control" rows="15" id="antecedentes" name="antecedentes" onkeypress="return cmTextoNum_hc_enf(event);" required></textarea>
                                              </div>
                                              <div class="form-group col-md-12">
                                                <label for="nota" class="col-form-label"><strong>Valoración Subjetiva estado general:</strong></label>
                                                <textarea class="form-control" rows="8" id="valoracionsubjetiva" name="valoracionsubjetiva" onkeypress="return cmTextoNum_hc_enf(event);" required></textarea>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                            ...
                                            <div class="row">
                                              <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="" id="svfc" name="svfc" minlength="1" maxlength="6" pattern="\S[0-9A-Za-z, ]{1,6}" onkeypress="return cmTextoNum_hc_enf(event);"required />
                                                </div>
                                              </div>
                                              <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="" id="svfr" name="svfr" minlength="1" maxlength="8" pattern="\S[A-Za-z0-9,. ]{1,8}" onkeypress="return cmTextoNum_hc_enf(event);"required />
                                                </div>
                                              </div>
                                              <div class="form-group col-md-4">
                                                <label class="col-form-label"><strong>Sístole</strong></label>  
                                                <input type="text" class="form-control" placeholder="" id="sisenf" name="sisenf" onkeyup="sumartensionarterialenf();" minlength="1" maxlength="6" pattern="\S[A-Za-z0-9 ]{1,6}" onkeypress="return cmTextoNum_hc_enf(event);" required />

                                                <label class="col-form-label"><strong>Diástole</strong></label>
                                                <input type="text" class="form-control" placeholder="" id="diasenf" name="diasenf" onkeyup="sumartensionarterialenf();" minlength="1" maxlength="6" pattern="\S[A-Za-z0-9 ]{1,6}" onkeypress="return cmTextoNum_hc_enf(event);"required />
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="" id="svta" name="svta" onkeypress="return cmTextoNum_hc_enf(event);" required />
                                                </div>
                                              </div>
                                              <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="" id="svt" name="svt" minlength="1" maxlength="6" pattern="\S[A-Za-z0-9 ]{1,6}" onkeypress="return cmTextoNum_hc_enf(event);" required />
                                                </div>
                                              </div>
                                              <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="" id="svsaturacion" name="svsaturacion" minlength="1" maxlength="6" pattern="\S[A-Za-z0-9,. ]{1,6}" onkeypress="return cmTextoNum_hc_enf(event);" required />
                                                </div>
                                              </div>
                                              <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="" id="svglucometria" name="svglucometria" minlength="1" maxlength="6" pattern="\S[A-Za-z0-9,. ]{1,6}" onkeypress="return cmTextoNum_hc_enf(event);" required />
                                                </div>
                                              </div>
                                          ...
                                          <div class="card-body">
                                            <div class="row">
                                              <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" placeholder="" id="dom1p1" name="dom1p1" minlength="1" maxlength="500" pattern="\S[A-Za-z0-9,. ]{1,500}" onkeypress="return cmTextoNum_hc_enf(event);" required />
                                              </div>
                                              <div class="form-group col-md-12">
                                                <label for="nota" class="col-form-label"><strong>¿Necesita mayor información sobre su enfermedad?:</strong></label>
                                                <input type="text" class="form-control" placeholder="" id="dom1p2" name="dom1p2" minlength="1" maxlength="500" pattern="\S[A-Za-z0-9,. ]{1,500}" onkeypress="return cmTextoNum_hc_enf(event);" required />
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                              ...
                                              <div class="form-group col-md-12">
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-md-4">
                                                    ...
                                                    <div class="form-check">
                                                      <input class="form-check-input" type="radio" name="d4movilidad" onclick="verificarradiopad_enf()"  value="hemiparexia">
                                        ...
                                        <div class="card-body">
                                          ...
                                          <div class="row">
                                            <div class="form-group col-md-6">
                                              ...
                                              <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="lis3[]" onclick="verificachekintervencion_enf()" value="Motilidad intestinal">
    ...
    <script type="text/javascript">
      ...
      function obtener_local_enf(){
          //obtener variable
          let dt=JSON.parse(localStorage.getItem("hc_enf_campos"));

          if(dt)
          {
            var confirm= alertify.confirm('Mensaje','Tiene una Historia primera Desea Recuperala ?',null,null).set('labels', {ok:'Si', cancel:'No'});  

            confirm.set({transition:'slide'});    
            //boton confirmar
            confirm.set('onok', function(){ 
                
                alertify.success('Recuperada');
               
            });
            //boton cancelar 
            confirm.set('oncancel', function(){ 
                alertify.error('Sin recuperar');
                localStorage.removeItem("hc_enf_campos");//limpiar  variable
                location.reload();//recargamos
                
            });
            // console.log(dt["nota"]+" "+dt["celular"]);
            //dt donde se obtine para mostrar dt["nombre dado"];
            $('#antecedentes').val(dt["antecedentes"]);
            $('#valoracionsubjetiva').val(dt["valoracionsubjetiva"]);   
            $('#svfc').val(dt["svfc"]);    
            $('#svfr').val(dt["svfr"]);
            $('#sisenf').val(dt["sisenf"]);
            $('#diasenf').val(dt["diasenf"]);    
            $('#svta').val(dt["svta"]);
            $('#svt').val(dt["svt"]);                
            $('#svsaturacion').val(dt["svsaturacion"]);
            $('#svglucometria').val(dt["svglucometria"]);    
            $('#dom1p1').val(dt["dom1p1"]);
            $('#dom1p2').val(dt["dom1p2"]);    
          }
          else
          {
