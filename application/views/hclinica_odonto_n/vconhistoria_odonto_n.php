                ...
                <div class="col-md-12">
                  <div class="card-header">
                    <ul class="nav nav-tabs nav-justified"><!-- primary btn-lg btn-block -->
                        <li class="nav-item">
                          <a class="nav-link active bg-white " id="uno" href="#multi1" data-toggle="collapse" data-target="#multi1" aria-expanded="false" aria-controls="multi1" onclick="pasar('1')"><FONT SIZE=5>Historia Odontologica Primera Vez</FONT></a>
                        </li>
                        <!-- <li class="nav-item">
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                  ...
                                                  <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="37°" id="sac" name="sac" minlength="1" maxlength="6" pattern="\S[A-Za-z0-9,. ]{1,6}" required />
                                                  </div>
                                                </div>
                                                <div class="form-group col-md-2">
                                                  <label class="col-form-label"><strong>GLUC:</strong></label>
                                                  <div class="input-group">
                                                    <div class="input-group-prepend">
                                                      <span class="input-group-text">
                                                        <img src="<?php echo base_url();?>assets/img/iconos/combo.png" class="rounded-circle" width="22px" height="22px">
                                              ...
                                              <div class="row">
                                                <div class="form-group col-md-6">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                      <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="acceso_venoso[]" id="acceso_venoso6" onclick=""  value="Drun" >
                                                      ...
                                                      <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="acceso_venoso[]" id="acceso_venoso8" onclick=""  value="Implamtado" >
                                                        <label class="form-check-label">Implamtado</label>
                                                      </div>
                                                      <div class="form-check">
                                                      ...
                                                      <div class="form-group"></br></br>
                                                        ...
                                                        <input class="form-control" type="date" id="acfinsercion" name="acfinsercion" style="display:" >
                                                ...
                                                <div class="form-group col-md-6">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-md-6">
                                                      ...
                                                      <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="ostomina[]" id="ostomina5" onclick="" value="Reostomia">
                                                    ...
                                                    <div class="col-md-6">
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" id="ofostomina" name="ofostomina" style="display:" >
                                                ...
                                                <div class="form-group col-md-12">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                      ...
                                                      <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="vesical[]" id="vesical7" onclick=""  value="Sitostomia">
                                                        <label class="form-check-label">Citostomia</label>
                                                      </div>
                                                      <div class="form-check">
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" id="sfpostura" name="sfpostura" style="display:" >
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="row">
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>Medico:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycmedico[]" id="aycmedico1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycmedico[]" id="aycmedico2" onclick=""  value="Diario" >
                                                          <label class="form-check-label">Diario</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycmedico[]" id="aycmedico3" onclick=""  value="Interdiario">
                                                          <label class="form-check-label">Interdiario</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycmedico[]" id="aycmedico4" onclick=""  value="Semanal" >
                                                          <label class="form-check-label">Semanal</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycmedico[]" id="aycmedico5" onclick="" value="Quincenal">
                                                          <label class="form-check-label">Quincenal</label>
                                                        </div>
                                                        
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycmedico[]" id="aycmedico6" onclick=""  value="Mensual" >
                                                          <label class="form-check-label">Mensual</label>
                                                          <input type="text" class="form-control" id="auxaycmedico" name="auxaycmedico" style="display:none"/>
                                                        </div>                                        
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>Enfermera:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycenfermera[]" id="aycenfermera1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycenfermera[]" id="aycenfermera2" onclick=""  value="Consulta" >
                                                          <label class="form-check-label">Consulta</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycenfermera[]" id="aycenfermera3" onclick=""  value="Seguimiento">
                                                          <label class="form-check-label">Seguimiento</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycenfermera[]" id="aycenfermera4" onclick=""  value="Educacion" >
                                                          <label class="form-check-label">Educacion</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>Trabajo Social:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctsocial[]" id="ayctsocial1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctsocial[]" id="ayctsocial2" onclick=""  value="Ingreso" >
                                                          <label class="form-check-label">Ingreso</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctsocial[]" id="ayctsocial3" onclick=""  value="Seguimiento">
                                                          <label class="form-check-label">Seguimiento</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctsocial[]" id="ayctsocial4" onclick=""  value="Educacion" >
                                                          <label class="form-check-label">Educacion</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>Nutricion:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycnutricion[]" id="aycnutricion1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycnutricion[]" id="aycnutricion2" onclick=""  value="Ingreso" >
                                                          <label class="form-check-label">Ingreso</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycnutricion[]" id="aycnutricion3" onclick=""  value="Seguimiento">
                                                          <label class="form-check-label">Seguimiento</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycnutricion[]" id="aycnutricion4" onclick=""  value="Educacion" >
                                                          <label class="form-check-label">Educacion</label>
                                                  ...
                                                  <div class="row">
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>Fisioterapia:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycfisioterapia[]" id="aycfisioterapia1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycfisioterapia[]" id="aycfisioterapia2" onclick=""  value="Intervencion" >
                                                          <label class="form-check-label">Intervencion</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycfisioterapia[]" id="aycfisioterapia3" onclick=""  value="Seguimiento">
                                                          <label class="form-check-label">Seguimiento</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="aycfisioterapia[]" id="aycfisioterapia4" onclick=""  value="Educacion" >
                                                          <label class="form-check-label">Educacion</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>T. Respiratoria:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctrespiratoria[]" id="ayctrespiratoria1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctrespiratoria[]" id="ayctrespiratoria2" onclick=""  value="Intervencion" >
                                                          <label class="form-check-label">Intervencion</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctrespiratoria[]" id="ayctrespiratoria3" onclick=""  value="Seguimiento">
                                                          <label class="form-check-label">Seguimiento</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctrespiratoria[]" id="ayctrespiratoria4" onclick=""  value="Educacion" >
                                                          <label class="form-check-label">Educacion</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>T. Ocupacional:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctocupacional[]" id="ayctocupacional1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctocupacional[]" id="ayctocupacional2" onclick=""  value="Intervencion" >
                                                          <label class="form-check-label">Intervencion</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctocupacional[]" id="ayctocupacional3" onclick=""  value="Seguimiento">
                                                          <label class="form-check-label">Seguimiento</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctocupacional[]" id="ayctocupacional4" onclick=""  value="Educacion" >
                                                          <label class="form-check-label">Educacion</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>T. Lenguaje:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctlenguaje[]" id="ayctlenguaje1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctlenguaje[]" id="ayctlenguaje2" onclick=""  value="Intervencion" >
                                                          <label class="form-check-label">Intervencion</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctlenguaje[]" id="ayctlenguaje3" onclick=""  value="Seguimiento">
                                                          <label class="form-check-label">Seguimiento</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayctlenguaje[]" id="ayctlenguaje4" onclick=""  value="Educacion" >
                                                          <label class="form-check-label">Educacion</label>
                                                  ...
                                                  <div class="row">
                                                    <div class="form-group col-md-3">
                                                      <label class="col-form-label text-uppercase"><strong>Aux. Enfermeria:</strong></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria2" onclick=""  value="6 Hs D" >
                                                          <label class="form-check-label">6 Hs D</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria3" onclick=""  value="12 Hs D">
                                                          <label class="form-check-label">12 Hs D</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria4" onclick=""  value="12 Hs N" >
                                                          <label class="form-check-label">12 Hs N</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria5" onclick=""  value="24 Hs" >
                                                          <label class="form-check-label">24 Hs</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                      <label></label>
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria6" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria7" onclick=""  value="Medicamento" >
                                                          <label class="form-check-label">Medicamento</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria8" onclick=""  value="Nutricion">
                                                          <label class="form-check-label">Nutricion</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria9" onclick=""  value="Curacion" >
                                                          <label class="form-check-label">Curacion</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="auxenfermeria[]" id="auxenfermeria10" onclick=""  value="Sonda" >
                                                          <label class="form-check-label">Sonda</label>
                                                          <input type="text" class="form-control" id="auxauxenfermeria" name="auxauxenfermeria" style="display:none"/>
                                                        </div>
                                                    </div>                                       
                                                    <div class="form-group col-md-4"><br>
                                                      <div class="form-group">
                                                        <label class="form-check-label"><strong>Otro:</strong> </label>
                                                        <input type="text" class="form-control" placeholder="/24" id="otroenfermeria" name="otroenfermeria" required />
                                                      </div>                                     
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="form-group col-md-12">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-md-6">
                                                       <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion1" onclick="" value="No Selecciona">
                                                          <label class="form-check-label">No Selecciona</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion2" onclick=""  value="Prevencion de Accidentalidad en el hogar" >
                                                          <label class="form-check-label">Prevencion de Accidentalidad en el hogar</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion3" onclick=""  value="Mantenimiento de higiene corporal">
                                                          <label class="form-check-label">Mantenimiento de higiene corporal</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion4" onclick=""  value="Suministro de Alimentiacion beneficiosa" >
                                                          <label class="form-check-label">Suministro de Alimentiacion beneficiosa</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion44" onclick=""  value="Estimulo y manejo corporal y de la movilidad" >
                                                          <label class="form-check-label">Estimulo y manejo corporal y de la movilidad</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion5" onclick="" value="Manejo de residuos domesticos">
                                                          <label class="form-check-label">Manejo de residuos domesticos</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion6" onclick=""  value="Lavado de manos" >
                                                          <label class="form-check-label">Lavado de manos</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion7" onclick=""  value="Mantenimiento de vestuario y habitacion" >
                                                          <label class="form-check-label">Mantenimiento de vestuario y habitacion</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion8" onclick=""  value="Manejo de comodidad y seguridad del pacinete" >
                                                          <label class="form-check-label">Manejo de comodidad y seguridad del pacinete</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion9" onclick=""  value="Suministro de medicamentos orales" >
                                                          <label class="form-check-label">Suministro de medicamentos orales</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion10" onclick=""  value="Obtencion de insumos y medicamentos" >
                                                          <label class="form-check-label">Obtencion de insumos y medicamentos</label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="ayceducacion[]" id="ayceducacion11" onclick=""  value="Control de citas asistenciales" >
                                                          <label class="form-check-label">Control de citas asistenciales</label>
