<?php
	...
	class PDF extends FPDF
	{
		...
		public function Header()
		{
			...
			$this->Cell(10);
			$this->SetFont('Arial','B',8);
			$this->Cell(18,0,'F.Escala:',0,0,1);
			$this->SetFont('Arial','',8);
			$this->Cell(12,0,$GLOBALS['obfechaescala'],0,0,1);
			$this->Cell(10);
			$this->SetFont('Arial','B',8);
			$this->Cell(18,0,'H.Escala:',0,0,1);
			$this->SetFont('Arial','',8);
	...
	else
	{
		...
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Siente que debudo al tiempo que dedica a su familiar ya no dispone de tiempo suficiente para usted?'),0,'J');
		$pdf->Cell(16,5,$carga_2,0,0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Se siente tenso cuando tiene que cuidar a su familiar y atender ademas otras responsibilidades?'),0,'J');
		...
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Se siente enfadado cuando esta cerca de su familiar?'),0,'J');
		$pdf->Cell(16,5,$carga_5,0,0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Cree que la situacion actual afecta de manera negativa a su relacion con amigos y otros miembros de su familia?'),0,'J');
		...
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Se siente agobiado cuando tiene que estar juanto a su familiar?'),0,'J');
		...
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Siente que no tiene la vida privada que desearia debido a su familiar?'),0,'J');
		$pdf->Cell(16,5,$carga_11,0,0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Cree que su vida socila se ha visto afectada por tener que cuidar de su familiar?'),0,'J');
		...
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Cree que su familiar espera que usted le cuide, como si fuera la unica persona con la que puede contar?'),0,'J');
		$pdf->Cell(16,5,$carga_14,0,0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Cree que no dispone de dinero suficiente para cuidar a su familiar ademas de sus otros gastos?'),0,'J');
		$pdf->Cell(16,5,$carga_15,0,0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Siente que sera incapaz de cuidar a su familiar por mucho mas tiempo?'),0,'J');
		$pdf->Cell(16,5,$carga_16,0,0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		...
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Desearia poder encargar el cuidado de su familiar a otras personas?'),0,'J');
		...
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Siente que deberia hacer mas de lo que hace por su familiar?'),0,'J');
		$pdf->Cell(16,5,$carga_20,0,0,'C');
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',8);
		$pdf->Cell(180,5,utf8_decode('¿Cree que podria cuidar de su familiar mejor de lo que lo hace?'),0,'J');
