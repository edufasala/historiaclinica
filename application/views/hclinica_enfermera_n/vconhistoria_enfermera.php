    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Consultar Historia Enfermeria</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Consultar</a></li>
              <li class="breadcrumb-item active">Consultar Historia Enfermeria</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                            ...
                                            <div class="row">
                                              <div class="form-group col-md-2">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="12 Cm" id="svfc" name="svfc" minlength="1" maxlength="6" pattern="\S[0-9A-Za-z, ]{1,6}" required />
                                                </div>
                                              </div>
                                              <div class="form-group col-md-2">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="55,5 Kg" id="svfr" name="svfr" minlength="1" maxlength="8" pattern="\S[A-Za-z0-9,. ]{1,8}" required />
                                                </div>
                                              </div>
                                              <div class="form-group col-md-2">
                                              ...
                                              <div class="form-group col-md-2">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="37°" id="svsaturacion" name="svsaturacion" minlength="1" maxlength="6" pattern="\S[A-Za-z0-9,. ]{1,6}" required />
                                                </div>
                                              </div>
                                              <div class="form-group col-md-2">
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-md-4">
                                                    <div class="row">
                                                      ...
                                                      <div class="col-md-12">
                                                        <div class="form-check">
                                                          <label class="form-check-label">Caracteristicas</label>
                                          ...
                                          <div class="card-body">
                                            <div class="row">
                                              <div class="form-group col-md-12">
                                                ...
                                                <div class="row">
                                                  <div class="col-md-4">
                                                    <label class="form-check-label text-uppercase"><strong>Deposiciones:</strong> </label>
                                                    <div class="form-check">
                                                    ...
                                                    <div class="form-group">
                                                      <label class="form-check-label "><strong>Tipo</strong> </label>
                                                      <input type="text" class="form-control" id="dom3tipo" name="dom3tipo">
                                                    </div> 
                                                  </div>
                                                  <div class="col-md-4">
                                                    <label class="form-check-label">vomito</label>
                                                    <div class="row">
                                                       <div class="form-group col-md-4">
                                                        <div class="form-check">
                                                  ...
                                                  <div class="col-md-4">
                                                    <label class="form-check-label text-uppercase"><strong>Oresis:</strong> </label>
                                                    <div class="form-check">
                                            ...
                                            <div class="row">
                                              <div class="form-group col-md-12">
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-md-4">
                                                    <label class="form-check-label text-uppercase"><strong>Fiebre:</strong></label><br><br>
                                                    <div class="form-check">
                                                  ...
                                                  <div class="col-md-4">
                                                    ...
                                                    <div class="form-group"><br><br>
                                                      ...
                                                      <input type="date" class="form-control" id="d4pulsofecha" name="d4pulsofecha">
                                      ...
                                      <div class="card">
                                        <div class="card-header" id="headiuno">
                                          ...
                                          aria-expanded="false" aria-controls="enfpdd1">
                                            Dominio 5: Rercepcion Cognicion
                                          </button>
                                        </div>
                                        <div class="collapse" id="enfpdd1" aria-labelledby="headiuno" data-parent="#separa2">
                                          <div class="card-body">
                                            <div class="row">
                                              ...
                                              <div class="row">
                                                <div class="col-md-4">
                                                  <label class="form-check-label text-uppercase"><strong>Escala de Glasgow:</strong> </label><br><br>
                                                  <div class="form-check">
                                                ...
                                                <div class="col-md-4">
                                                  <label class="form-check-label text-uppercase"><strong>Estado de conciencia</strong></label><br><br><br>
                                                  <div class="form-check">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                  ...
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d6lenguaje" id="d6lenguaje2" onclick=""  value="tutubeante">
                                                    <label class="form-check-label">tutubeante</label>
                                                  </div>
                                                  <div class="form-check">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="row">
                                                <div class="col-md-3">
                                                  ...
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d7familiares" id="d7familiares8" onclick=""  value="No aplica">
                                                    <label class="form-check-label">No aplica</label>
                                                  </div>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d7familiares" id="d7familiares1" onclick=""  value="afectiva">
                                                    <label class="form-check-label">afectiva</label>
                                                  </div>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d7familiares" id="d7familiares2" onclick=""  value="indiferente">
                                                    <label class="form-check-label">indiferente</label>
                                                  </div>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d7familiares" id="d7familiares3" onclick=""  value="hostial">
                                                    <label class="form-check-label">hostial</label>
                                                  </div>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d7familiares" id="d7familiares4" onclick=""  value="distante">
                                                    <label class="form-check-label">adistante</label>
                                                  </div>
                                                </div>
                                                <div class="col-md-3"><br>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d7familiares" id="d7familiares5" onclick=""  value="abandono familiar">
                                                    <label class="form-check-label">abandono familiar</label>
                                                  </div>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d7familiares" id="d7familiares6" onclick=""  value="maltrato familiar">
                                                    <label class="form-check-label">maltrato familiar</label>
                                                  </div>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d7familiares" id="d7familiares7" onclick=""  value="abuso familiar">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                  ...
                                                  <div class="form-group">
                                                    <label class="form-check-label"><strong>Especifique</strong></label>
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="row">
                                                <div class="col-md-3">
                                                  ...
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d11seguridad" id="d11seguridad1" onclick=""  value="CVP" >
                                                    <label class="form-check-label">CVP</label>
                                                  </div>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="d11seguridad" id="d11seguridad2" onclick=""  value="CVC">
                                                  ...
                                                  <div class="form-group">
                                                    <label class="form-check-label"><strong>Otros</strong></label>
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                  ...
                                                  <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">deficinete</label>
                                                  </div>
                                                  <div class="form-check">
                                                  ...
                                                  <div class="form-group"><br>
                                                    <label class="form-check-label">Especifique<strong></strong></label>
                            ...
                            <div class="collapse" id="escala1" aria-labelledby="headiuno" data-parent="#separa5">
                              <div class="card-body">
                                <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                    <input type="date" class="form-control" id="carga_fecha" name="carga_fecha" />
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="form-group col-md-8">
